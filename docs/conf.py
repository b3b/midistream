...
project = u'Midistream'
copyright = u'2015, b3b'
...
htmlhelp_basename = 'Midistreamdoc'
...
latex_documents = [
  ('index', 'Midistream.tex', u'Midistream Documentation',
   u'b3b', 'manual'),
]
...
man_pages = [
    ('index', 'midistream', u'Midistream Documentation',
     [u'b3b'], 1)
]
...
texinfo_documents = [
  ('index', 'Midistream', u'Midistream Documentation',
   u'b3b', 'Midistream', 'One line description of project.',
   'Miscellaneous'),
]
